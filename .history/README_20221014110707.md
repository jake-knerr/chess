...
#### Prefer to use `REM` for font sizes (or anything that should scale with fonts) amd use `px` for everything else.

Do not change the default `font-size`.

> Why? This way users can change the font size of your document without affecting layout.
